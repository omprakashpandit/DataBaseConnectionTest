...
public class MongoDBTest {
	...
	public static void main(String[] args) {
		...
		MongoClientURI uri = new MongoClientURI(
				"mongodb+srv://omprakash:1234@cluster0.z5oxtrc.mongodb.net/zap?retryWrites=true&w=majority&appName=Cluster0");
		...
		for (Document d : doc) {
			System.out.println("Name: " + d.get("name") + " " + "Country: " + d.get("country") + " " + "Population: "
					+ d.get("population"));
